...
<div class="jumbotron">
  ...
  <p style="font-size: 18px">
  	assadujjaman.nayeem@northsouth.edu<br>
  	Zawad.hoassain@gmail.com<br>
  	sanzidanur.suhona@northsouth.edu<br>
  	rajesh.roy@northsouth.edu<br>
    sangeeta.paul@northsouth.edu<br></p></aside>
...
?>
 ...
 <!---Link footer ---->
    ...
    <div class="c1 container-fluid">
        <a  href="home.php" ><button type="button" class="btn btn-link" style="color: white;font-size:20px ;margin-top: 30px">Join Us</button></a>
        <a  href="home.php" ><button type="button" class="btn btn-link" style="color: white;font-size:20px ;margin-left: 38%;margin-top: 30px;" id="about">About</button></a>
        <a  href="#" ><button type="button" class="btn btn-link" style="color: white;font-size:20px;float: right; margin-top: 30px">Contact Us</button></a>
